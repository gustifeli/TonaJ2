<%-- 
    Document   : GaleriaVerano2
    Created on : 14/05/2018, 18:59:36
    Author     : GustiFeli
--%>
    ...
    <body>
        ...
        <div>
            <div class="grid-container">
                <c:forEach items="${producto2}" var="p">
                    <div class="polaroid2">
                        <img style="width: 100%; height: 500%" src="ObtenerImagenGaleriaPrimaVerano?cod=${p.idproducto}" alt="Imagen Producto">
