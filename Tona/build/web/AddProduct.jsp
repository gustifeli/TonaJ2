...
<!--                                        <label class="checkbox-inline"><input type="checkbox" name="campaña" value="1">Primavera-Verano</label>
                                        <label class="checkbox-inline"><input type="checkbox" name="campaña" value="2">Otoño-Invierno</label>-->
